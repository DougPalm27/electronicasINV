    ...
    const tabla = $('#tblCuentasGPS').DataTable({
        ...
        columns: [
            ...
            { data: null, className: 'text-center', orderable: false,
              render: (d,t,r) => `
                <button class="btn btn-sm btn-warning btn-editar-cu me-1"
                        data-id="${r.id_cuenta}"
                ...
                <button class="btn btn-sm ${r.activo==1?'btn-danger':'btn-success'} btn-toggle-cu"
                        data-id="${r.id_cuenta}" title="${r.activo==1?'Desactivar':'Activar'}">
